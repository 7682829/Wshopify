...
{
    _id: "bot1",
    name: "Men Corduroy Brown Trousers",
    description: "A stylish and modern corduroy brown trousers with a tailored fit, paired with sharp sunglasses. Perfect for both formal and semi-formal occasions. The timeless brown color and clean lines will elevate your wardrobe effortlessly.",
    price: 120,
    image: [bot1],
    category: "Men",
...
{
    _id: "bot2",
    name: "Men Beige Trendy Trousers",
    description: "A vibrant beige trousers, paired with a high summer fashion yellow trenchcoat. This fashion-forward combination is perfect for colder months, offering both warmth and standout style. Designed for the modern man who values both comfort and fashion.",
    price: 160,
    image: [bot2],
    category: "Men",
    subCategory: "Outerwear",
...
{
    _id: "bot3",
    name: "Women Chic White Pleated Skirt",
...
{
    _id: "bot4",
    name: "Unisex Neutral Tone Beige Trousers",
    description: "A minimalist neutral tone trousers paired with sleek white sneakers. The perfect combination of comfort and elegance, this outfit is designed for easygoing style that transitions seamlessly from work to weekend.",
    price: 150,
    image: [bot4],
    category: "Unisex",
...
{
    _id: "bot5",
    name: "Men White Pleated Shorts with White T-shirt",
